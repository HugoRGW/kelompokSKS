...
<link rel="stylesheet" href="{{ asset('assets/scss/card.scss') }}" />
...
<link rel="stylesheet" href="{{ asset('user/css/carding.css') }}" />
...
<script src="{{ asset('user/js/bootstrap.min.html') }}"></script>
