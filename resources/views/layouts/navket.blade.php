...
<a href="index.html"><h2>Ekstraku</h2></a>
...
<ul id="sidebar_menu">
   ...
   <li class="">
    <a class="has-arrow active" href="#" aria-expanded="false">
        <div class="icon_menu">
            <img src="{{ asset ('user/img/menu-icon/dashboard.svg') }}" alt="">
        </div>
        <span  style="color: #c70000;">Postingan</span>
    </a>
    <ul>
...
<li class="">
    <a href="{{ route('tambah.postingan') }}"  aria-expanded="false">
    <div class="icon_menu">
